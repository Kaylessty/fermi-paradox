...
public class MonsterAI {
    ...
    class Timer extends TimerTask {
        ...
        private void runTeeth() {
            ...
            int y = 0;
            try {
                TimeUnit.SECONDS.sleep(4 - Room.getDifficulty());
        ...
        private void runTreeBore() {
            ...
            //theStage.setScene(scene1);
            new FadeOut(projectile).play();
            new FadeOut(projectilea).play();
            new FadeOut(projectileb).play();
            new FadeOut(projectilec).play();
            new FadeOut(projectiled).play();
            MonsterAI.this.damageCalculation(projectile);
