...
public class EngiShop extends Monster {
    ...
    private static Item[] shopInv = {new Item(Item.Possession.SHIELDGENERATOR_LV1,
            15, 15, "Shield Generator LV1"),
    ...
    private Item drop = new Item(Item.Possession.SHIELDGENERATOR_LV3,
            15, 15, "Shield Generator LV3");
    private int health;
    private int speed;
    ...
    public String[][] getSpeech() {
        String[][] speech = {{"I'm Engi! I was hired to work aboard the station as a "
                    + "cybernetics specialist before this whole mess. "
                    + "Something really strange is going on.. and i don't  just mean the aliens!"
                    + " Have you noticed that the rooms here don't seem to be connected in a way "
                    + "that's physically possible? perhaps its some sort of worm hole "
                    + "technology... or maybe we are in a place which has entirely different "
                    + "laws of physics!! OH OH ALSO... wait.. sorry i'm rambling again! "},
            {"I'm trying to find a determinable pattern to the station, map it out... "
                    + "see which rooms lead were. So far a map of this station would "
                    + "be impossible. I'm on the verge of a breakthrough here!"
                    + " interesting right?"}, {"Scientific experimentation often "
                    + "contains many risks! Risks that sometimes result in getting "
                    + "a sweet robot arm!"}};
        return speech;
    }
