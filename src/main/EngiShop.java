...
public class EngiShop extends Monster {
    ...
    private static Item[] shopInv = {
        new Item(Item.Possession.SHIELDGENERATOR_LV1, 15, 15, "Shield Generator LV1"),
    ...
    public void damage(int amount, MathHelper.Direction knockback) {
        ...
        super.setLocation(currX + knockback.getDirX() * 90,
                currY + knockback.getDirY() * 90);
    }
    ...
    public String[][] getSpeech() {
        String[][] speech =
            {{"I'm Engi! I was hired to work aboard the station as"
                    + " a cybernetics specialist before this whole mess. Something really "
                    + "strange is going on.. and i don't  just mean the aliens! have you"
                    + " noticed that the rooms here don't seem to be connected in a way that's "
                    + "physically possible? perhaps its some sort of worm hole technology... "
                    + "or maybe we are in a place which has entirely different "
            ...
            {"I'm trying to find a determinable pattern to the station, map it out... "
                    ...
                    + " interesting right?"},
            {"Scientific experimentation often contains many risks! Risks that "
