...
public class ClownShop extends Monster {
    ...
    private static Item[] shopInv = {
        new Item(Item.Possession.BALLOON_R, 15, 15, "Red Balloon"),
    ...
    private Item drop =
            new Item(Item.Possession.HORN, 15, 15, "Clown's Prized Horn");
    private int health;
    private int speed;
    ...
    public String[][] getSpeech() {
        String[][] speech =
            {{"Names Howard, i'm the stations resident funny man. "
                    + "Not sure why the boys back home thought it necessary to hire a"
                    + " clown... but hay, a job's a job's... or... job"},
            {"Working... these alien things don't seem to attack unless provoked"
                    + " so... my contract says if I'm not in immediate danger..."
                    + " well, i'd rather deal with these fellas than deal with boss man."},
            {"Kid... did ya bump yer head er something? We're in space, "
                    + "same as always... although... i can't really recall how we got here..."},
            {"Kid... look... I.... It's.... Do i ask you about the minute details of"
                    + " every part of your life? Gimme a break kid."}};
        return speech;
    }
    ...
    public String[] getTalks() {
        String[] talks = {
            "Who are you?", "What are you doing here?", "Where are we?",
            "How do you smoke your Cigarette with that helmet on?"};
        return talks;
    }
