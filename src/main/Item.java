...
public class Item implements Locatable, Collectible {
    ...
    public enum Possession  {
        A_ENERGYSWORD("Sword", 200000, 1, 4, 0, 0, 0,
                100000, 100000, true, false, -1,
        ...
        SHADOWSWORD("Sword", 1500, 1, 4, 0, 0, 0,
                80000, 50000, true, false, -1,
        ...
        SONICSWORD("Sword", 500, 3, 4, 0, 0, 0,
                10000, 8000, true, false, -1,
        ...
        DB_SONICSWORD("Sword", 1000, 3, 4, 0, 0, 0,
                30000, 27000, true, false, -1,
        ...
        H_RIFLE("Gun", 1500, 20, 4, 0, 0, 0,
                95000, 88000, true, false, -1,
        ...
        BATTERYLV1("heal", 2500, 0, 1, 0, 0, 0,
                500, 300, true, false, -1,
        ...
        BATTERYLV2("heal", 5000, 0, 1, 0, 0, 0,
                1000, 900, true, false, -1,
        ...
        SHADOWGAUNTLET("misc", 0, 0, 1, 0, 0, 0,
                20000, 17000, true, false, -1,
        ...
        SHIELDGENERATOR_LV1("Shield", 2500, 0, 1, 0, 0, 0,
                10000, 9000, true, false, -1,
        ...
        SHIELDGENERATOR_LV2("Shield", 5000, 0, 1, 0, 0, 0,
                40000, 37000, true, false, -1,
        ...
        SHIELDGENERATOR_LV3("Shield", 10000, 0, 1, 0, 0, 0,
                80000, 70000, true, false, -1,
                "A small device which when placed on a user, "
        ...
        Possession(String type, int damage, int range, int housingSpace, int healthBoost,
                   int strengthBoost, int speedBoost, int purchaseCost, int returnCost,
                   boolean walkable, boolean unlocker, int idLevel,
