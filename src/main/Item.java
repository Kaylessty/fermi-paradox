...
public class Item implements Locatable, Collectible {
    ...
    */
    public enum Possession  {
        ...
        ENERGYSWORD("Sword", 500, 1, 4, 0, 0, 0, 500, 300, true, false, -1,
                "resources/images/ENERGYSWORD.png"),
        DB_ENERGYSWORD("Sword", 1000, 1, 4, 0, 0, 0, 500, 300, true, false, -1,
                "resources/images/DB_ENERGYSWORD.png"),
        SONICSWORD("Sword", 500, 3, 4, 0, 0, 0, 500, 300, true, false, -1,
                "resources/images/SONICSWORD.png"),
        DB_SONICSWORD("Sword", 1000, 3, 4, 0, 0, 0, 500, 300, true, false, -1,
                "resources/images/DB_SONICSWORD.png"),
        LASER("Gun", 150, 7, 4, 0, 0, 0, 500, 300, true, false, -1,
        ...
        A_RIFLE("Gun", 900, 10, 4, 0, 0, 0, 2000, 1000, true, false, -1,
        ...
        IMPROVISEDGUN("Gun", 56, 3, 3, 0, 0, 0, 600, 250, true, false, -1,
        ...
        BOREEYE("misc", 1000, 0, 1, 0, 0, 0, 999999, 0, true, false, -1,
                "resources/images/BOREEYE.png"),
        HIDE("misc", 500, 0, 1, 0, 0, 0, 999999, 0, true, false, -1,
                "resources/images/TEAFFHIDE.png"),
        TIMKEY("misc", 0, 0, 1, 0, 0, 0, 999999, 0, true, false, -1,
