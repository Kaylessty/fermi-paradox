...
public class Item implements Locatable, Collectible {
    ...
    public enum Possession  {
        ...
        SHADOWSWORD("Sword", 1500, 1, 4, 0, 0, 0, 80000, 50000, true, false, -1,
                "resources/images/SHADOWSWORD.png"),
        TOOTHBRUSH("Sword", 2500, 1, 4, 0, 0, 0, 80000, 50000, true, false, -1,
        ...
        SHOCKRIFLE("Gun", 400, 10, 4, 0, 0, 0, 8000, 6500, true, false, -1,
                "resources/images/SHOCKRIFLE.png"),
        PISTOL("Gun", 400, 10, 4, 0, 0, 0, 5500, 3000, true, false, -1,
                "resources/images/PISTOL.png"),
        A_RIFLE("Gun", 3000, 20, 4, 0, 0, 0, 9000000, 7000000, true, false, -1,
                "resources/images/RIFLE.png"),
        SONICRIFLE("Gun", 350, 5, 4, 0, 0, 0, 1000, 700, true, false, -1,
                "resources/images/SONICRIFLE.png"),
        SONICCANNON("Gun", 850, 5, 4, 0, 0, 0, 20000, 17000, true, false, -1,
                "resources/images/SONICCANNON.png"),
        A_SHOCKRIFLE("Gun", 60000, 20, 4, 0, 0, 0, 100000, 100000, true, false, -1,
                "resources/images/A_SHOCKRIFLE.png"),
        H_RIFLE("Gun", 1500, 20, 4, 0, 0, 0, 95000, 88000, true, false, -1,
        ...
        TIMKEY("misc", 0, 0, 1, 0, 0, 0, 1500, 1000, true, false, -1,
                "resources/images/TIMKEY.png"),
        BOREHEART("misc", 0, 0, 1, 0, 0, 0, 20000, 17000, true, false, -1,
                "resources/images/BOREHEART.png"),
        SHADOWGAUNTLET("misc", 0, 0, 1, 0, 0, 0, 20000, 17000, true, false, -1,
